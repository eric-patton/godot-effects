...
// NOTE: `readonly` dropped (Godot 4.6 RD requires the access qualifier to match the
// always-writable bound descriptor); the shader still only reads it.
layout(rgba16f, set = 0, binding = 0) restrict uniform image2DArray spectrum;
